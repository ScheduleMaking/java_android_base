// 메모 내용을 수정하는 Activity.
// [수정] 버튼을 클릭하면 UPDATE SET 명령이 실행되어 내용이 수정되어 저장된다.
...
public class ModifyMyData extends Activity {
    ...
    public void modifyData(View v){
        try{
            ...
            String str_s = t1.getText().toString();
            String sql = String.format("UPDATE diaryTB SET data2 = '%s' WHERE data1 = '%s'", str_s, diary_date);
